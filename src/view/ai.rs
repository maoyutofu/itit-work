            ...
            <div
                ...
                <a href="https://api2d.com/r/220092" target="_blank">
                    <div
                        ...
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/api2d.com.png" alt="" />
                ...
                <a href="https://qianwen.aliyun.com" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/tongyi.aliyun.com.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://hunyuan.tencent.com" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/hunyuan.tencent.com.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://yiyan.baidu.com" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/yiyan.baidu.com.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://www.doubao.com" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/www.doubao.com.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://chatglm.cn" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/chatglm.cn.svg" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://kimi.moonshot.cn" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/kimi.moonshot.cn.ico" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://cloud.baidu.com/product/wenxinworkshop" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/qianfan.cloud.baidu.com.ico" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://xinghuo.xfyun.cn" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/xinghuo.xfyun.cn.ico" alt="" />
                        <div class="ml-3 truncate">
        ...
        <section class="my-5 bg-white shadow-md p-6">
            ...
            <div
                ...
                <a href="https://chat.openai.com" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/chat.openai.com.svg" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://claude.ai" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/claude.ai.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://gemini.google.com" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/gemini.google.com.svg" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://www.perplexity.ai" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/perplexity.ai.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://mistral.ai" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/mistral.ai.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://duckduckgo.com/?q=DuckDuckGo+AI+Chat&ia=chat&duckai=1" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/duckduckgo.com.png" alt="" />
                        <div class="ml-3 truncate">
        ...
        <section class="my-5 bg-white shadow-md p-6">
            ...
            <div
                ...
                <a href="https://github.com/facebookresearch/llama" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/llama.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://github.com/QwenLM/Qwen" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/qwen.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://github.com/01-ai/Yi" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/01ai.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://github.com/THUDM/ChatGLM3" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/chatglm3.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="https://github.com/baichuan-inc" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="https://itit-work-1251679744.cos.ap-guangzhou.myqcloud.com/images/baichuan.png" alt="" />
                        <div class="ml-3 truncate">
