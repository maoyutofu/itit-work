        ...
        <section class="my-5">
            ...
            <div
                ...
                <a href="/toml" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="/images/toml.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="/case-converter" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="/images/case-converter.png" alt="" />
                        <div class="ml-3 truncate">
                ...
                <a href="/password" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="/images/password.png" alt="" />
                        <div class="ml-3 truncate">
                            <h3 class="text-sm truncate">密码生成器</h3>
                            <p class="text-xs text-gray-400 truncate" inner_html="在线随机密码生成器"></p>
                        </div>
                    </div>
                </a>
                <a href="/mac" target="_blank">
                    <div
                        class="flex items-center h-20 px-3 lg:px-5 bg-white hover:translate-y-[-1px] hover:shadow-lg transition-transform duration-300">
                        <img class="w-10 h-10" src="/images/mac_address.png" alt="" />
                        <div class="ml-3 truncate">
                            <h3 class="text-sm truncate">MAC 生成器</h3>
                            <p class="text-xs text-gray-400 truncate" inner_html="在线 MAC 生成器"></p>
                        </div>
                    </div>
                </a>
            </div>
